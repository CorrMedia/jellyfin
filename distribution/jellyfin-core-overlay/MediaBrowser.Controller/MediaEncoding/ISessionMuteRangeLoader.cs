...
/// are loaded for a session before the stream request checks for a session audio filter.
...
public interface ISessionMuteRangeLoader
{
    ...
    System.Threading.Tasks.Task EnsureMuteRangesLoadedAsync(string? playSessionId, string? deviceId, string? itemId, System.Threading.CancellationToken cancellationToken);
}
