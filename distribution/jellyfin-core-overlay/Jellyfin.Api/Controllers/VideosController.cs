...
public class VideosController : BaseJellyfinApiController
{
    ...
    public VideosController(
        ...
        ILogger<VideosController>? logger = null)
    {
        ...
        [FromQuery] bool enableAudioVbrEncoding = true)
    {
        ...
        var hasMuteFilter = _encodingHelper.HasSessionAudioFilterForRequest(streamingRequest.PlaySessionId, streamingRequest.DeviceId);
        if (hasEditGraph || hasMuteFilter)
        {
        ...
        if (hasEditGraph)
        {
            ...
            // Keep StartTimeTicks — edit graph truncates keep-ranges to the edited-timeline seek.
        }
